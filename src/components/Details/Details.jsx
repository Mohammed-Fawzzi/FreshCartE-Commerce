...
export default function Details() {
  ...
  return (
    <>
      ...
      <div className="row align-items-center my-5 de-par">
        ...
        <div className="col-md-9">
          ...
          <button onClick={()=>addToWL(param.id)} id={param.id} className={ `heart-btn d-heart w-25 m-0 fs-2 `}>
            <i  class="d-heart fa-solid fa-heart m-0 ms-5"></i>
          </button>
